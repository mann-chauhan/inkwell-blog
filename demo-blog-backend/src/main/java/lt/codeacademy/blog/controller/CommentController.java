...
public class CommentController {
    ...
    @PostMapping
    public ResponseEntity<JsonNode> addComment(@Valid @RequestBody ContentRequest contentRequest) {
    ...
    @PutMapping
    public ResponseEntity<JsonNode> updateComment(@Valid @RequestBody ContentRequest contentRequest) {
